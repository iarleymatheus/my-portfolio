  ...
  return (
    <NavigationStyled>
        ...
        <ul className='nav-items'>
              ...
              <li className='nav-item'>
                 <NavLink to='/resume' activeClassName='active-class'>Portfólios</NavLink>
              </li>
              <li className='nav-item'>
                 <NavLink to='/portfolios' activeClassName='active-class'>Blogs</NavLink>
              </li>
              <li className='nav-item'>
            ...
            display: block;
             a{
                ...
                &::before{
                      ...
                      height: 50%;
                      background-color: var(--primary-color);
                      transition: All 0.4s cubic-bezier(.89,.09,.08,.98);
                      z-index:3;
                      opacity: 0.21;
